...
const LAST_ACTIVITY_ANNOTATION = "notebooks.sandatasystem.com/last-activity"
...
func SetStopAnnotation(meta *metav1.ObjectMeta, m *metrics.Metrics) {
	...
	if meta.GetAnnotations() != nil {
		if _, ok := meta.GetAnnotations()["notebooks.sandatasystem.com/last_activity"]; ok {
			delete(meta.GetAnnotations(), "notebooks.sandatasystem.com/last_activity")
		}
	}
}
